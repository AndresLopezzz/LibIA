...
/// Obtiene el directorio base donde se almacenarán los datos de la aplicación
/// 
/// En Windows: `%LOCALAPPDATA%\app_name`
/// En macOS: `~/Library/Application Support/app_name`
/// En Linux: `~/.local/share/app_name`
...
mod tests {
    ...
    fn test_init_db() {
        ...
        assert!(db_path.exists(), "El directorio de BD debe existir en disco");
    ...
    fn test_db_path_correct_for_os() {
        ...
        #[cfg(target_os = "linux")]
        {
            ...
            assert!(path_str.contains(".local") || path_str.contains("share"),
